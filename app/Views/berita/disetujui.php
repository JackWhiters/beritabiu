    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><?= esc($judul); ?></h3>
                <p class="text-subtitle text-muted">List Tabel dari berita yang telah dikirim dan disetujui.</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tabel Berita Disetujui</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="justify-content-between d-flex mb-0">
                    <div class="col-md-8">
                        <h4 class="card-title">Table Berita Disetujui</h4>
                        <p class="text-subtitle text-muted">
                            Menampilkan Data Berita Yang Telah Dikirim dan Disetujui.
                        </p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <tbody class="align-middle">
                        ...
                        foreach ($berita as $berita) { ?>
                            <tr>
                                ...
                                <td>
                                    <small>
                                        <i class="fa fa-tags"></i> <a href="<?= base_url('berita/kategori/' . $berita['id_kategori']) ?>">
                                            <?= $berita['nama_kategori'] ?>
                                        </a>
                                        <br><i class="fa fa-home"></i> <a href="<?= base_url('berita/jenis_berita/' . $berita['jenis_berita']) ?>">
                                            <?= $berita['jenis_berita'] ?>
                                        </a>
                                    </small>
                                </td>
