                ...
                <div class="justify-content-between d-flex mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="justify-content-end d-flex">
                            <a href="<?php echo base_url('berita') ?>" class="btn btn-success"><i class="fa-solid fa-plus"></i> Tambah Berita</a>
                        </div>
                    </div>
                </div>
                <hr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal"><i class="fa-solid fa-eye me-1"></i> Detail</a>
                                <a href="javascript:void(0)" class="btn btn-warning text-dark btn-sm" data-bs-toggle="modal" data-bs-target="#modal-terima"><i class="fa-solid fa-check"></i> Terima</a>
                                <a href="javascript:void(0)" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal-hapus"><i class="fa-solid fa-trash"></i> Hapus</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<!-- Modal Terima -->
<div class="modal fade text-left" id="modal-terima" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel1">Terima Berita</h5>
                <button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close">
                    <i data-feather="x"></i>
                </button>
            </div>
            <div class="modal-body">
                <p>
                    Terima Berita ? <br>
                    jika berita diterima, maka berita akan tampil di halaman utama.
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close">Batal</button>
                <a class="btn btn-warning" href="#">Terima</a>
                </button>
            </div>
        </div>
    </div>
