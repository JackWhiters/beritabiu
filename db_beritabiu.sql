...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Sep 2022 pada 09.17
...
(56, 1, 2, 'dummy-03', 'Dummy 03', 'Dummy 03', '<h1>Dummy 03</h1>', 'Publish', '', '', '1661273041user-03.jpg', NULL, 0, '2022-08-23 23:44:01', '2022-09-02 14:01:00', '2022-09-02 07:02:01'),
(57, 1, 2, 'dummy-45', 'Dummy -45', 'Dummy -45', '<h1>Dummy -45</h1>', 'Draft', '', '', '1661308216user-04.jpg', NULL, 0, '2022-08-24 09:30:16', '2022-09-15 19:11:00', '2022-09-15 12:11:33'),
...
(59, 1, 1, 'dummy-06', 'Dummy 06', 'Dummy 06', '<h1>Dummy 06</h1>', 'Publish', '', '', '1661308269work1.jpg', NULL, 0, '2022-08-24 09:31:09', '2022-09-02 14:01:00', '2022-09-02 07:01:43'),
(60, 24, 5, 'berita-user', 'Berita User', 'ini merupakan berita yang diinput oleh user', '<h1>Berita Buatan User</h1>', 'Publish', '', '', '1661496746usaf-rocket.jpg', NULL, 0, '2022-08-26 13:52:26', '2022-09-15 18:20:00', '2022-09-15 11:20:29'),
(61, 2, 6, 'kegiatan-lomba-17-agustus-2022', 'Kegiatan Lomba 17 Agustus 2022', 'Pada tanggal 17 Agustus 2022 Universitas Bina Insani mengadakan lomba untuk memeriahkan hari kemerdekaan Indonesia ke-77', '<h1>Kegiatan Lomba 17 Agustus 2022</h1>\r\n<p>Pada tanggal 17 Agustus 2022 Universitas Bina Insani mengadakan lomba untuk memeriahkan hari kemerdekaan Indonesia ke-77</p>\r\n<p>Lomba yang dilaksanakan antara lain :</p>\r\n<ul>\r\n<li>Stumble Guys</li>\r\n<li>Balap Karung&nbsp;</li>\r\n<li>Badminton</li>\r\n<li>Futsal</li>\r\n<li>Tenis Meja</li>\r\n</ul>', 'Publish', '', '', '1663239381ArtPropelled.jfif', NULL, 0, '2022-09-15 17:56:22', '2022-09-15 18:03:00', '2022-09-15 11:03:55'),
(62, 2, 2, 'berita-dummy-baru', 'Berita Dummy Baru', 'ini adalah berita dummy yang dibuat oleh user', '<p>ini adalah berita dummy yang dibuat oleh user</p>', 'Publish', '', '', '1663240392d273e29e-506f-45dc-bcc2-245c06b142fc.jfif', NULL, 0, '2022-09-15 18:13:13', '2022-09-15 18:14:00', '2022-09-15 11:15:23');
...
(1, 1, 'web-design', 'Penelitian', 1, 0, '2022-09-02 06:54:36'),
(2, 1, 'berita', 'PKM', 2, 0, '2022-09-02 06:54:45'),
...
INSERT INTO `tb_kategori` (`id`, `nama_kategori`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT INTO `tb_pengaturan` (`nama_toko`, `no_telp`, `alamat`, `youtube`) VALUES
('BeritaBIU', '081234567890', 'Jalan Narogong Raya', 'https://www.youtube.com/embed/fuadn7oMYGs');
